...
class FireDataset(Dataset):
    def __init__(self, root,  transforms = None, train = 'train', normalize = False, channel_multiplier = [1,1,1]):
        if train== 'train':
...
#FireDataset('/home/taekwang0094/WorkSpace/Summer_Conference').__getitem__(1100)